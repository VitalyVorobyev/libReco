...
// * Unflavored and strange meson makers * //
  ...
  /// Kstar0 -> K- pi+
  static int make_kstar0(std::vector<Particle> &kst0l,// to be filled
  ...
  static int make_kstar0(std::vector<Particle> &kst0l,std::vector<Particle> &kst0bl,// to be filled
                         std::vector<Particle> &kml,std::vector<Particle> &pipl, //      K*0 -> K- pi+
                         std::vector<Particle> &kpl,std::vector<Particle> &piml);// anti-K*0 -> K+ pi-
  /// phi -> K+ K-
...
// * D0 makers * //
  /// D0 -> Ks0 h+ h-
  static int make_d0tok0shh(std::vector<Particle> &d0l,// to be filled
                            std::vector<Particle> &ksl,std::vector<Particle> &hpl,std::vector<Particle> &hml,
                            const int mode = 20);
  /// D0 -> K+K-, pi+pi-, Ks0 pi0,  Ks0 eta, Ks0 omega, Ks0 phi
  static int make_d0tohh(std::vector<Particle> &d0l,// to be filled
                         std::vector<Particle> &h1l,std::vector<Particle> &h2l,
                         const int mode = 21, const bool narrow = false); 
  /// D0 -> K+ pi-
  static int make_d0tokpi(std::vector<Particle> &d0l,// to be filled
  ...
  static int make_d0tokpi(std::vector<Particle> &d0l,std::vector<Particle> &d0bl,// to be filled
                          std::vector<Particle> &kml,std::vector<Particle> &pipl,//      D0 -> K- pi+
                          std::vector<Particle> &kpl,std::vector<Particle> &piml,// anti-D0 -> K+ pi-
                          const int mode = 10);
  /// D0 -> K+ pi- pi0
  static int make_d0tokpipi0(std::vector<Particle> &d0l,// to be filled
                             ...
                             std::vector<Particle> &pi0l,const int mode = 11, const bool narrow = false); 
  /// D0 -> K+ pi- pi0, separated flavors
  static int make_d0tokpipi0(std::vector<Particle> &d0l,std::vector<Particle> &d0bl,// to be filled
                             std::vector<Particle> &kml,std::vector<Particle> &pipl,//      D0 -> K- pi+ pi0
                             std::vector<Particle> &kpl,std::vector<Particle> &piml,// anti-D0 -> K+ pi- pi0
                             std::vector<Particle> &pi0l,const int mode = 11, const bool narrow = false);
  /// D0 -> K+ pi- pi+ pi-
  static int make_d0tokpipipi(std::vector<Particle> &d0l,// to be filled
  ...
  static int make_d0tokpipipi(std::vector<Particle> &d0l,std::vector<Particle> &d0bl,// to be filled
                              std::vector<Particle> &kml,std::vector<Particle> &pipl,//      D0 -> K- 2pi+ pi-
                              std::vector<Particle> &kpl,std::vector<Particle> &piml,// anti-D0 -> K+ 2pi- pi+
                              const int mode = 12, const bool narrow = false);
// * D+ makers * //
  /// D+ -> K- 2pi+
  static int make_dptokpipi(std::vector<Particle> &dpl,// to be filled
  ...
  static int make_dptokpipi(std::vector<Particle> &dpl,std::vector<Particle> &dml,// to be filled
                          std::vector<Particle> &kml,std::vector<Particle> &pipl,// D+ -> K- 2pi+
                          std::vector<Particle> &kpl,std::vector<Particle> &piml,// D- -> K+ 2pi-
                          const int mode = 110);
  /// D* -> D {gamma, pi0, pi+}
  static int make_dstar(std::vector<Particle> &dstl,// to be filled
                         std::vector<Particle> &dl,std::vector<Particle> &xl);
// * Ds makers * //
  /// Ds+ -> phi pi+, Ks0 K+. The first particle is neutral, the second is charged
  static int make_dstoh0hp(std::vector<Particle> &dsl,// to be filled
                            std::vector<Particle> &h0l,std::vector<Particle> &hpl,std::vector<Particle> &hml,
                            const int mode = 0);
  /// Ds+ -> phi pi+, Ks0 K+, separated flavors
  static int make_dstoh0hp(std::vector<Particle> &dspl,std::vector<Particle> &dsml,// to be filled
                            std::vector<Particle> &h0l,std::vector<Particle> &hpl,std::vector<Particle> &hml,
                            const int mode = 0);
  /// Ds+ -> anti-K*0 K+
  static int make_dstoKK(std::vector<Particle> &dsl,// to be filled
  ...
  static int make_dstoKK(std::vector<Particle> &dspl,std::vector<Particle> &dsml,// to be filled
                         std::vector<Particle> &kst0bl,std::vector<Particle> &kpl,// Ds+ -> anti-K*0 K+
                         std::vector<Particle> &kst0l, std::vector<Particle> &kml,// Ds- ->      K*0 K-
                         const int mode = 1);
  /// D*s -> Ds gamma
  static int make_dsstar(std::vector<Particle> &dsstl,// to be filled
                         std::vector<Particle> &dsl,std::vector<Particle> &gammal);
  /// D*sj -> D(*)s X
  static int make_dsjtodsx(std::vector<Particle> &dsjl,
                           std::vector<Particle> &dspl,std::vector<Particle> &dsml,
                           std::vector<Particle> &xl,const int mode = 0);
  /// D*sj -> D(*)s X, separated flavors
  static int make_dsjtodsx(std::vector<Particle> &dsjpl,std::vector<Particle> &dsjml,
                           std::vector<Particle> &dspl,std::vector<Particle> &dsml,
                           std::vector<Particle> &xl,const int mode = 0);
  /// D*sj -> D(*)s X1 X2
  static int make_dsjtodsxy(std::vector<Particle> &dsjl,
                            std::vector<Particle> &dspl,std::vector<Particle> &dsml,
                            std::vector<Particle> &xl,std::vector<Particle> &yl,const int mode = 0);
  /// D*sj -> D(*)s X1 X2, separated flavors
  static int make_dsjtodsxy(std::vector<Particle> &dsjpl,std::vector<Particle> &dsjml,
                            std::vector<Particle> &dspl,std::vector<Particle> &dsml,
                            std::vector<Particle> &xl,std::vector<Particle> &yl,const int mode = 0);
// * Interface for configuration * //
  ...
  /// D0 mass window
  static void Set_md0_range(const double& x,const double& y) {m_d0mmin = x; m_d0mmax = y;}
  /// K*0 mass window
  static void Set_kst0_range(const double& x,const double& y) {m_kst0mmin = x; m_kst0mmax = y;}
  /// D*s mass difference window
  static void Set_Dsst_dm_range(const double& x,const double& y) {m_dsst_dm_min = x; m_dsst_dm_max = y;}
  /// D*sj mass window
  static void Set_Dsj_range(const double& x,const double& y) {m_mdsstj_min = x; m_mdsstj_max = y;}
private:
  ...
  static double m_egamma_pi0_min;
